...
public interface ExtrinsicPQ<T> {
    /* Inserts an item with the given priority value. This is
     * also known as "enqueue", or "offer".
     */
    ...
    T removeMin();
    /* Changes the priority of the given item. The behavior if
     * the item doesn't exist is undefined.
     */
